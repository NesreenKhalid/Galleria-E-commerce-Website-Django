...
class Product(models.Model):
   ...
   # productImageID=models.ForeignKey(ProductPicture, on_delete=models.CASCADE, verbose_name=("Product Image"))#minaEdit
    ...
    def __str__(self):#minaEdit
        return str(self.name)#minaEdit
